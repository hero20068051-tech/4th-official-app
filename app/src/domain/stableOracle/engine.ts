// FROZEN COPY of the engine as of tag stable-saitama-women-2026-09-24 (Phase 2.5).
// Used only by ruleset.differential.test.ts as an oracle: the Saitama ruleset must
// behave exactly like this code. Do not edit; delete once the ruleset work is merged and trusted.
